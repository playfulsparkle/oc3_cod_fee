...
$_['text_getting_started']       = '<p><strong>Přehled:</strong> Rozšíření Playful Sparkle - Poplatek za dobírku pro OpenCart 3 umožňuje majitelům obchodů přidat konfigurovatelný poplatek k objednávkám využívajícím metodu platby na dobírku (COD). Tato funkce pomáhá kompenzovat poplatky za zpracování dobírky a poskytuje větší kontrolu nad celkovými náklady na objednávku.</p><p><strong>Požadavky:</strong> OpenCart 3.0+, PHP 7.2 nebo vyšší.</p>';
