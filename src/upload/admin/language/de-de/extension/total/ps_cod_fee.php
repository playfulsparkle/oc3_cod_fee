...
$_['text_getting_started']       = '<p><strong>Überblick:</strong> Die Erweiterung "Playful Sparkle - COD-Gebühr" für OpenCart 3.x ermöglicht es Shop-Besitzern, eine konfigurierbare Gebühr zu Bestellungen hinzuzufügen, die die Zahlungsmethode Nachnahme (COD) verwenden. Diese Funktion hilft, die Bearbeitungsgebühren für Nachnahme zu kompensieren und bietet mehr Kontrolle über die Gesamtsumme der Bestellungen.</p><p><strong>Voraussetzungen:</strong> OpenCart 3.x+, PHP 7.3 oder höher.</p>';
